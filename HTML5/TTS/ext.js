var pageToSpeech = {
    ...
    addHotkeys: function() {
        var activeKeys = [];
        onkeydown = onkeyup = function(evt) { // bind event callback to window
            var e = evt || event; //  workaround regarding events in earlier IE
                                  //  @see: http://stackoverflow.com/questions/960419/javascript-ie-event
